...
CB_Net.REST = function() { return CB_Net.REST; };
{
	...
	CB_Net.REST.actionProcess = function(actionName, additionalData, XHR, serverURL, avoidProxy)
	{
		...
		var callbackErrorWrapper =
			function(XHRObject)
			{
				if (typeof(callbackError) === "function") { callbackError.call(XHRObject, actionName, XHRObject, additionalData); }
			};
		...
		var callbackOkWrapper =
			function(XHRObject)
			{
				...
				if (typeof(CB_Net.REST.callbackOk_PERMANENT) === "function") { CB_Net.REST.callbackOk_PERMANENT.call(XHRObject, actionName, XHRObject, callbackError, additionalData); }
				if (typeof(CB_Net.REST.actions[actionName]["callbackOk"]) === "function")
				{
					CB_Net.REST.actions[actionName]["callbackOk"].call(XHRObject, actionName, XHRObject, callbackError, additionalData);
				}
				else if (typeof(CB_Net.REST.actions[actionName]["callbackOk"]) === "undefined" && typeof(CB_Net.REST.callbackOk_DEFAULT) === "function")
				{
					CB_Net.REST.callbackOk_DEFAULT.call(XHRObject, actionName, XHRObject, callbackError, additionalData);
				}
			};
