...
CB_Controllers_Proprietary.WII_U = function() { return CB_Controllers_Proprietary.WII_U; };
{
	...
	CB_Controllers_Proprietary.WII_U.init = function()
	{
		...
		if (typeof(wiiu.gamepad) === "undefined" || wiiu.gamepad === null)
		{
			wiiu.gamepad =
			{
				...
				lStickX: undefined, //GamePad Left Control Stick X deflection.
				lStickY: undefined, //GamePad Left Control Stick Y deflection.
				rStickX: undefined, //GamePad Right Control Stick X deflection.
				rStickY: undefined, //GamePad Right Control Stick Y deflection.
	...
	{
		return CB_Controllers_Proprietary.WII_U.gamepadLastStatus = CB_Controllers_Proprietary.WII_U.wiiuObject.gamepad.update();
	}
	...
	CB_Controllers_Proprietary.WII_U.getRemoteStatus = function(n)
	{
		...
		return CB_Controllers_Proprietary.WII_U.remoteLastStatus[n] = CB_Controllers_Proprietary.WII_U.wiiuObject.remote.update(n);
	}
	

	/**
	 * Returns an object with the gamepad and all remotes simulating the [GamePad API]{@link https://developer.mozilla.org/en-US/docs/Web/API/Gamepad_API}.
	 *  @function
	 *  @returns {Object} Returns an object with the current gamepad status object (as a value in the "gamepad" property) and a numeric array whose values are the status objects of all the remotes (as a value in the "remotes" property) simulating the [GamePad API]{@link https://developer.mozilla.org/en-US/docs/Web/API/Gamepad_API}.
	 *  @todo Normalize all to simulate the [GamePad API]{@link https://developer.mozilla.org/en-US/docs/Web/API/Gamepad_API}.
	...
	CB_Controllers_Proprietary.WII_U.getGamePads = function()
	{
		...
		return {
			"gamepad" : CB_Controllers_Proprietary.WII_U.getGamePadStatus(),
			"remotes" :
			[
				//TODO: check the documentation to find out the maximum number of remotes allowed.
				CB_Controllers_Proprietary.WII_U.getRemoteStatus(0),
				CB_Controllers_Proprietary.WII_U.getRemoteStatus(1),
				CB_Controllers_Proprietary.WII_U.getRemoteStatus(2),
				CB_Controllers_Proprietary.WII_U.getRemoteStatus(3),
				CB_Controllers_Proprietary.WII_U.getRemoteStatus(4),
				CB_Controllers_Proprietary.WII_U.getRemoteStatus(5),
				CB_Controllers_Proprietary.WII_U.getRemoteStatus(6),
				CB_Controllers_Proprietary.WII_U.getRemoteStatus(7)
			]
		};
	}
