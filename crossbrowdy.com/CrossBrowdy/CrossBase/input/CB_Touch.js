...
var CB_Touch = function() { return CB_Touch; };
{
	...
	CB_Touch.init = function()
	{
		...
		if (typeof(Hammer) !== "undefined" && Hammer !== null && Hammer.defaults)
		{
			//Chromium workaround (Chrome, Opera...) for Android thanks to Desiderius77, found on https://github.com/hammerjs/hammer.js/issues/1130#issuecomment-378851243.
			Hammer.defaults.inputClass = ((CB_Client.get() === "Chrome" || CB_Client.get() === "Opera") && Hammer.SUPPORT_POINTER_EVENTS) ? Hammer.PointerEventInput : Hammer.TouchInput;
		}
