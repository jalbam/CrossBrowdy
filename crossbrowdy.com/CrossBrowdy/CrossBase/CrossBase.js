...
var CB_CrossBaseCredits = 
	...
	"[CB] -- requestAnimationFrame polyfill by Erik Moller (fixes from Paul Irish, Tino Zijdel, Andrew Mao, Klemen Slavic, Darius Bacon and Tim Hall)<br />" +
...
{
	//TODO: Find a better way for this as old Firefox versions can only detect GamePad API support when the events are fired, so we cannot relay on navigator.getGamepads/navigator.webkitGetGamepads/navigator.webkitGamepads.
	return !!(typeof(navigator) === "object" && (navigator.getGamepads || navigator.webkitGetGamepads || navigator.webkitGamepads));
}
 ...
 *  @default
 */
CB_Configuration[CB_BASE_NAME].INTELXDK_INITDEVJS_LOAD = true; //CB_Configuration[CB_BASE_NAME].needsIntelXDKJS();
 ...
 *  @default function(currentPath, info) { return (typeof(dev) === "undefined" || dev === null || typeof(dev.initDeviceReady) !== "function"); }
 */
CB_Configuration[CB_BASE_NAME].INTELXDK_INITDEVJS_LOAD_CHECKER = function(currentPath, info) { return (typeof(dev) === "undefined" || dev === null || typeof(dev.initDeviceReady) !== "function"); };
 ...
 */
CB_Configuration[CB_BASE_NAME].CORDOVAJS_LOAD = !CB_Configuration[CB_BASE_NAME].PHONEGAPJS_LOAD; //CB_Configuration[CB_BASE_NAME].needsCordovaJS();
 ...
 *  @default
 */
CB_Configuration[CB_BASE_NAME].NOSLEEP_LOAD = true;
...
//Hammer.js parameters:
/**
 * Defines whether to load or not [Hammer.js]{@link http://hammerjs.github.io/}.
 *  @memberof CB_Configuration.CrossBase
 *  @name HAMMERJS_LOAD
 *	@constant
 *  @type {boolean}
...
/**
 * Directory that contains the [Hammer.js]{@link http://hammerjs.github.io/} files.
 *  @memberof CB_Configuration.CrossBase
 *  @name HAMMERJS_PATH
 *	@constant
 *  @type {string}
...
/**
 * Defines whether the path defined in {@link CB_Configuration.CrossBase.HAMMERJS_PATH_SCRIPT_FILE} is either absolute or relative to the CrossBrowdy script path.
 *  @memberof CB_Configuration.CrossBase
...
CB_Modules.modules[CB_BASE_NAME] =
{
	...
	"neededFiles" :
		{	//Format: "needed_file" : { load: needs_to_be_loaded, [mandatory: needed_to_begin_CrossBrowdy], [absolutePath: relative_to_CrossBrowdy_path_or_absolute], [loadChecker: function that will be called and return true if the file needs to be loaded], [id: file_identifier_string], [requires: array_with_required_ids_of_files_required] }
			//Mandatory files:
			"CrossBase/general/BrowserDetect.js" : { load: true, mandatory: true }, //BrowserDetect by Peter-Paul Koch.
			"CrossBase/general/requestAnimationFrame.js" : { load: true, mandatory: true }, //requestAnimationFrame polyfill by Erik Moller (fixes from Paul Irish, Tino Zijdel, Andrew Mao, Klemen Slavic, Darius Bacon and Tim Hall).
			"CrossBase/general/typedarray.js" : { load: true, mandatory: true, id: "typedarray" }, //typedarray.js polyfill by Linden Research, Inc. and Joshua Bell and Joshua Bell.
			"CrossBase/general/base64-binary.js" : { load: true, mandatory: true }, //Base64Binary by Daniel Guerrero.
			...
			"CrossBase/audiovisual/image/detect_zoom/new/detect_zoom.js" : { load: true, mandatory: true }, //Detect-zoom by yonran (maintained by tombigel).
			...
			"CrossBase/input/controllers/CB_Controllers_Proprietary_WII.js" : { load: true, mandatory: true }, //CB_Controllers_Proprietary_WII.js static class.
			"CrossBase/input/controllers/CB_Controllers_Proprietary_WII_U.js" : { load: true, mandatory: true }, //CB_Controllers_Proprietary_WII_U.js static class.
			...
			"VALUEOF_CB_Configuration.CrossBase.GAMEPAD_PLUS_PATH_SCRIPT_FILE" : { load: CB_Configuration[CB_BASE_NAME].GAMEPAD_PLUS_LOAD, mandatory: true, absolutePath: CB_Configuration[CB_BASE_NAME].GAMEPAD_PLUS_PATH_ABSOLUTE } //gamepad-plus by Chris Van Wiemeersch (MozVR).
