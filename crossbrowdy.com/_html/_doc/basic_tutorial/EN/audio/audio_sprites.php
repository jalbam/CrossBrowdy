...
<p>
	Audio file sprites objects (which are created using the <a href="api/CB_AudioFileSprites.html" target="_blank">CB_AudioFileSprites</a> class) allow you to use and reuse different sprites from the same sound multiple times and simultaneously.
</p>
...
<p>
	Internally, each audio file sprites object will normally manage one audio file cache object (which use the <a href="api/CB_AudioFileCache.html" target="_blank">CB_AudioFileCache</a> class) that will typically contain multiple <a href="api/CB_AudioFile.html" target="_blank">CB_AudioFile</a> objects. An audio file cache object can grow automatically (expanding itself) in the case it detects it needs more internal <a href="api/CB_AudioFile.html" target="_blank">CB_AudioFile</a> objects (for example, if it detects we want to play more sound instances simultaneously than the ones it currently has). It can also reload <a href="api/CB_AudioFile.html" target="_blank">CB_AudioFile</a> objects automatically in the case they failed internally. During this process, the audio file sprites object (<a href="api/CB_AudioFileSprites.html" target="_blank">CB_AudioFileSprites</a> object) will have a 'LOADING' status again and after that the status will be 'LOADED' if all went well or 'FAILED' otherwise. When the 'LOAD' status is reached, the 'onLoad' event function (if any) will be called again (to prevent this, set the 'onLoad' property of the object to something which is not a function once it gets executed).
</p>

<p>
	The <a href="api/CB_AudioFileSprites.html" target="_blank">CB_AudioFileSprites</a> class could be considered a wrapper for the <a href="api/CB_AudioFileCache.html" target="_blank">CB_AudioFileCache</a> class which has been enhanced to add sprites management features.
</p>

<p>
	The <a href="api/CB_AudioFileSprites.html" target="_blank">CB_AudioFileSprites</a> objects use a higher abstraction level than the <a href="api/CB_AudioFileCache.html" target="_blank">CB_AudioFileCache</a> but lower than the <a href="api/CB_AudioFileSpritesPool.html" target="_blank">CB_AudioFileSpritesPool</a> ones.
</p>
...
<p>
	In case we need it, we can also get the internal <a href="api/CB_AudioFileCache.html" target="_blank">CB_AudioFileCache</a> object to manage it:
</p>
<pre><code class="language-javascript line-numbers match-braces rainbow-braces">
...
<p>
	You can read more about the <a href="api/CB_AudioFileCache.html" target="_blank">CB_AudioFileCache</a> class in the <a href="<?php echo basicTutorialLink("audio", "audio_files_cache"); ?>" target="_blank">Audio files cache</a> topic.
</p>

<p>
	Although the <a href="api/CB_AudioFileCache.html" target="_blank">CB_AudioFileCache</a> object (used internally by <a href="api/CB_AudioFileSprites.html" target="_blank">CB_AudioFileSprites</a> objects) can automatically create new internal <a href="api/CB_AudioFile.html" target="_blank">CB_AudioFile</a> objects or remove them when needed, it is also possible to create new ones or remove current ones manually:
</p>
<pre><code class="language-javascript line-numbers match-braces rainbow-braces">
...
<p>
	One of the most interesting features when managing audio file sprites objects with CrossBrowdy is that you can change the audio API of all their internal <a href="api/CB_AudioFile.html" target="_blank">CB_AudioFile</a> objects on the fly (even when they are currently playing!). This can be done easily:
</p>
<pre><code class="language-javascript line-numbers match-braces rainbow-braces">
...
<p>
	Apart from some previous methods seen before, it is also possible to perform other bulk actions that will affect all the internal <a href="api/CB_AudioFile.html" target="_blank">CB_AudioFile</a> objects that the audio file sprites object uses:
</p>
<pre><code class="language-javascript line-numbers match-braces rainbow-braces">
...
<p>
	In order to free memory and resources, it is possible to destroy the audio file sprites object and its internal <a href="api/CB_AudioFile.html" target="_blank">CB_AudioFile</a> objects:
</p>
<pre><code class="language-javascript line-numbers match-braces rainbow-braces">
...
<p>
	Check the <a href="api/index.html" target="_blank">API documentation</a> to read more about the <a href="api/CB_AudioFileSprites.html" target="_blank">CB_AudioFileSprites</a> class.
</p>