...
<p>
	Note that the <a href="api/CB_Client.html#.exit" target="_blank">CB_Client.exit</a> method can use some fallbacks and workarounds internally to try to close the app when standard methods fail. This can be useful when it is running on web browsers and other platforms.
</p>
