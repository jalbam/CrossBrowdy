...
<p>
	After <a href="download<?php echo $PHPExtension; ?>" target="_blank">downloading</a> CrossBrowdy and placing it in your working folder (for this example, inside a subfolder called &quot;<i>CrossBrowdy</i>&quot;), create an HTML file with the following content:
</p>
...
<p>
	The recommended place to include this main JavaScript file, which is called <i>CrossBrowdy.js</i>, is inside the head section (inside the <a href="https://developer.mozilla.org/en-US/docs/Web/HTML/Element/head" target="_blank">&lt;head&gt; tag</a>) of the document.
</p>

<p>
	Alternatively, instead of downloading CrossBrowdy, you can <a href="https://en.wikipedia.org/wiki/Inline_linking" target="_blank">hotlink</a> it by directly pointing to a version available online. For instance this way you will be pointing to the last version:
</p>
<pre><code class="language-html line-numbers match-braces rainbow-braces">
...
<p>
	You can find a list of some <a href="https://en.wikipedia.org/wiki/Content_delivery_network" target="_blank">CDN providers</a> in the <a href="download<?php echo $PHPExtension; ?>#cdn_providers" target="_blank">Download section</a>. Thanks to them, you will be able to always use the last up-to-date version or even to point to a specific version you may prefer.
</p>
<p>
