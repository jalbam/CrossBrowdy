...
<p>
	This is an example of a simple <a href="https://en.wikipedia.org/wiki/Tower_defense" target="_blank">Tower defense game</a> (using the <a href="<?php echo examplesLink("advanced", "simple_game_engine"); ?>" target="_blank">Game engine module from the previous example</a>).
</p>

<p>
	This game is for one player. You can use a gamepad, the keyboard, the mouse or a touch screen to control the game.
</p>
