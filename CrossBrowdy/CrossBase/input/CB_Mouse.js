...
var CB_Mouse = function() { return CB_Mouse; };
{
	...
	CB_Mouse.init = function()
	{
		...
		CB_Events.add(window, "scroll", function() { CB_Mouse.CursorImage.move(); }, true, true, false);
	 ...
	 */
	CB_Mouse.getButtons = CB_Mouse.getButtonsDown = function()
	{
	...
	{
		return CB_Collisions.isPointOverElement(CB_Mouse.getX(), CB_Mouse.getY(), element);
	}
	...
	CB_Mouse.isOverLine = function(lineX1, lineY1, lineX2, lineY2, tolerance, element)
	{
		...
		{
			var mouseX = CB_Mouse.getXRelative(CB_Elements.getLeft(element));
			var mouseY = CB_Mouse.getYRelative(CB_Elements.getTop(element));
		}
		else
		{
		...
		return CB_Collisions.isPointOverLine(mouseX, mouseY, lineX1, lineY1, lineX2, lineY2, tolerance);
	}
	...
	CB_Mouse.isOverSegment = function(lineX1, lineY1, lineX2, lineY2, tolerance, element)
	{
		...
		return CB_Collisions.isPointOverSegment(mouseX, mouseY, lineX1, lineY1, lineX2, lineY2, tolerance);
	}
	...
	CB_Mouse.isOverRectangle = function(rectangleX, rectangleY, rectangleWidth, rectangleHeight, element)
	{
		...
		return CB_Collisions.isPointOverRectangle(mouseX, mouseY, rectangleX, rectangleY, rectangleWidth, rectangleHeight);
	}
	...
	CB_Mouse.isOverCircle = function(centreX, centreY, radius, element)
	{
		if (typeof(element) !== "undefined" && element !== null)
		{
			mouseX = CB_Mouse.getXRelative(CB_Elements.getLeft(element));
			mouseY = CB_Mouse.getYRelative(CB_Elements.getTop(element));
		}
		else
		{
			var mouseX = CB_Mouse.getX();
		...
		return CB_Collisions.isPointOverCircle(mouseX, mouseY, centreX, centreY, radius);
	}
	 ...
	 */
	CB_Mouse.isOverEllipse = function(centreX, centreY, radiusX, radiusY, rotation, rotationUseDegrees, radius, element)
	{
		if (typeof(element) !== "undefined" && element !== null)
		{
			mouseX = CB_Mouse.getXRelative(CB_Elements.getLeft(element));
		...
		return CB_Collisions.isPointOverEllipse(mouseX, mouseY, centreX, centreY, radiusX, radiusY, rotation, rotationUseDegrees, radius);
	}
	...
	*/
	...
	CB_Mouse.CursorImage.move = function(x, y)
	{
		if (CB_Mouse.CursorImage._showCursorImage)
		{
			if (typeof(CB_Mouse.CursorImage._cursorImageDiv) !== "undefined" && CB_Mouse.CursorImage._cursorImageDiv !== null && typeof(CB_Mouse.CursorImage._cursorImageDiv.style) !== "undefined")
			{
				try //IE6 throws errors sometimes.
				{
					CB_Mouse.CursorImage._cursorImageDiv.style.left = (x || CB_Mouse.getX(null, false) || 0) + "px";
					CB_Mouse.CursorImage._cursorImageDiv.style.top = (y || CB_Mouse.getY(null, false) || 0) + "px";
				}
				catch(E) {}
			}
		}
